          ...
          <div className="flex flex-col gap-8 pb-10">
            <div className="flex flex-col items-center justify-center gap-2">
              <h2 className={"font-tartuffo text-2xl text-fg-2"}>
                the french tototte
                <span className="align-super text-xs">&reg;</span>
              </h2>
              <Flag />
            </div>
      ...
      <section className="relative bg-bg-2 pb-52">
        ...
        <div className="container flex max-w-[700px] flex-col gap-10">
          ...
          <div className="flex flex-col gap-8 md:flex-row">
            ...
            <p className="text-fg-3">
              Cette technologie vous permet de changer en un clin d'oeil de
              saveur pour{" "}
              <span className="font-bold text-fg-1">
                voyager du bout des lèvres
              </span>
              .
            </p>
          </div>
      ...
      <section className="group bg-bg-2">
        <div className="container flex max-w-[700px] flex-col gap-10">
          ...
          <p className="max-w-xs text-fg-3">
            ...
            de 50 heures de suçotage grâce à sa batterie au lithium, assurant
            ainsi{" "}
            <span className="font-bold text-fg-1">
        ...
        <div className="flex items-center justify-center py-16">
          <Image
            ...
            width={700}
            height={700}
            className="-rotate-45 scale-90 transition duration-1000 group-hover:-rotate-12 md:scale-100"
          />
        </div>
      ...
      <section className="bg-gradient-to-b from-bg-2 via-bg-3 to-bg-2 pb-52">
        ...
        <div className="container flex max-w-[700px] flex-col items-center gap-8 md:-mt-20 md:flex-row md:gap-32 lg:-mt-32">
          ...
          <div className="flex flex-col gap-3">
            <div>
              <Link
                href="https://support.spotify.com/fr/article/spotify-connect/"
                target="_blank"
              >
                <ButtonOutline>
                  <Icons.spotify />
            ...
            <p className="text-fg-3">
              ...
              bluetooth,{" "}
              <span className="font-bold text-fg-1">dégustez vos morceaux</span>{" "}
              et vos vidéos préférées directement dans votre bouche.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col items-center justify-center gap-20 md:flex-row">
          ...
          <div className="flex max-w-xs flex-col gap-8">
            ...
            <p className="text-fg-3">
              ...
              , offrant un goût rare et recherché. Une collaboration qui révèle
              l'essence de l'excellence et de l'originalité, à savourer sans
              plus attendre.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-20">
          <div className="flex justify-center">
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-xs text-center text-fg-2 md:max-w-md">
                Nos totottes sont utilisées par les plus grands de ce monde et
