export function Button({
  ...
  return (
    <button
      className="my-1 bg-fg-2 px-6 py-2 font-medium text-bg-2 transition duration-500 hover:bg-black"
      {...props}
    >
      {props.children}
    </button>
...
export function ButtonOutline({
  ...
  return (
    <button
      className="flex gap-2 border border-fg-2 px-4 py-1 text-fg-2"
      {...props}
    >
      {props.children}
    </button>
