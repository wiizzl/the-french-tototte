...
export function Pods() {
  const pods = [
    ...
    },
    {
      title: "spicy",
      description:
        "Pour ceux qui aiment vivre des nouvelles chose tout les jours",
      ...
      <div className="container max-w-xl px-5">
        <div className="flex flex-col items-center gap-10 md:flex-row">
          ...
          <div className="text-center text-fg-3 md:text-start">
            ...
            <strong className="text-fg-1">decouvrez un monde de délices</strong>{" "}
            pour chaque envie.
          </div>
        </div>
      </div>
  ...
  return (
    <div className="group relative">
      ...
      <Image
        ...
        height={1}
        className={
          "relative transition duration-300 group-hover:-translate-y-12"
        }
        alt="Image du pod"
      />
      <div
        className={`absolute w-[300px] translate-y-48 scale-0 border border-fg-1 bg-bg-2 p-5 opacity-0 transition duration-300 group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100 ${tooltipPosition}`}
      >
        <Image
