...
export function Bento() {
    ...
    return (
        <div className="container grid min-h-[52rem] max-w-[1000px] grid-cols-1 grid-rows-3 gap-3 md:grid-cols-3">
            <div className={`col-span-1 row-span-2 items-end bg-gradient-to-b from-bg-1 to-bg-blue ${bentoClass.grid}`}>
                <Image
            ...
            >
                <Image
                    ...
                    width={200}
                    height={200}
                    className={`absolute inset-x-0 top-10 m-auto group-hover:-rotate-6 group-hover:scale-110 ${bentoClass.transition}`}
                />
            ...
            >
                <Image
                    ...
                    width={400}
                    height={400}
                    className={`absolute -bottom-10 left-20 scale-125 group-hover:-translate-y-6 ${bentoClass.transition}`}
                />
            ...
            <div className={`col-span-1 row-span-1 items-start overflow-hidden bg-bg-blue md:col-span-2 ${bentoClass.grid}`}>
                <Image
            ...
            <div className={`col-span-1 row-span-1 items-end bg-bg-3 hover:bg-bg-1 ${bentoClass.grid} ${bentoClass.transition}`}>
                <div className="container absolute top-5">
                    <Flag hover transition={`md:group-hover:h-20 ${bentoClass.transition}`} />
                </div>
                <div className="container">
