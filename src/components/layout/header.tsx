...
export function Header({ scrollRef }: { scrollRef: MutableRefObject<HTMLDivElement | null> }) {
    ...
    return (
        <header
            className={`fixed z-50 w-full select-none pt-9 ${scrolled && "bg-gradient-to-b from-bg-2 from-30% to-transparent"}`}
        >
            <div className="container flex justify-between">
                ...
                >
                    <h2 className="ml-16 font-tartuffo text-2xl text-fg-2">the french tototte</h2>
                </div>
