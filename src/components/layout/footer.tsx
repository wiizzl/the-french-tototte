...
export function Footer() {
  const { content, selection, ornement, finition, ornements, finitions } =
    useCartStore();

  const socials = [
    {
      href: "https://instagram.com/bastiii/",
      icons: <Icons.instagram className="text-fg-3" />,
    },
    {
      href: "https://www.youtube.com/watch?v=FVEqE47pOLw",
      icons: <Icons.youtube className="text-fg-3" />,
    },
    {
      href: "https://threads.net/@bastiii",
      icons: <Icons.threads className="text-fg-3" />,
    },
    {
      href: "https://fr.linkedin.com/in/bastienmarecaux",
      icons: <Icons.linkedin className="text-fg-3" />,
    },
    {
      href: "https://x.com/BastiUi",
      icons: <Icons.twitter className="text-fg-3" />,
    },
    {
      href: "https://github.com/wiizzl/the-french-tototte",
      icons: <Icons.github className="text-fg-3 " />,
    },
  ];
      ...
      <div className="container flex flex-col gap-32 md:gap-96 lg:gap-0">
        <div className="flex justify-end">
          <div className="flex flex-col gap-6 lg:max-w-md">
            <h2 className="font-tartuffo text-4xl text-bg-1">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between">
                <div>
                  <p className="text-sm text-bg-3">
                    1 &times; thefrenchtototte
                  </p>
                  <div className="ml-3">
                    <p className="text-sm text-bg-3">
                      + Finition {finitions[finition].title.toLowerCase()}
                    </p>
                    <p className="text-sm text-bg-3">
                      + Ornement {ornements[ornement].title.toLowerCase()}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex justify-between">
                <p className="text-sm text-bg-3">
                  1 &times; {content[selection].title}
                </p>
              ...
              <div className="flex justify-between">
                ...
                <p className="text-sm text-bg-3">
                  <NumberTicker value={getTotalPrice()} />
                  ,00 &euro;
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between">
                <p className="text-sm text-bg-3">
                  Commandez avant <NumberTicker value={17} />h
                </p>
                <div className="flex items-center gap-1">
                  <p className="text-sm text-bg-3">
            ...
            <div className="flex flex-col gap-3">
              <Button onClick={() => alert("Sérieusement !?")}>
                Ajouter au panier
              </Button>
              <p className="text-xs/3 text-fg-3">
                <span className="font-tartuffo">the french tototte</span> est
                couverte par une garantie limitée contre les défauts de
                fabrication pour une période de 2 mois à compter de la date
                d'achat. Cette garantie ne couvre pas les dommages causés par
                une mauvaise utilisation, une négligence ou une modification non
                autorisée du produit. Dans les limites permises par la loi,
                thefrenchtototte décline toute responsabilité pour les dommages
                directs, indirects, spéciaux, accidentels ou consécutifs
                découlant de l'utilisation ou de l'incapacité d'utiliser
                thefrenchtototte, même si thefrenchtototte a été informée de la
                possibilité de tels dommages. En utilisant thefrenchtototte,
        ...
        <div className="z-10 flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end">
            <h1 className="text-nowrap font-tartuffo text-4xl text-fg-3 md:text-6xl">
              the french tototte
              <span className="align-super text-xl">&reg;</span>
            </h1>
            <div className="flex flex-col pb-1">
              <p className="text-xs text-fg-3">
                Copyright &copy; 2024{" "}
                <span className="font-tartuffo">the french tototte</span>. Tous
                droits réservés{" "}
              ...
              <p className="text-xs text-fg-3">
                ...
                print par Lunath, développement web par Pierre Houllière &
